...
export function StoreIcon({ size = 24, ...p }: IconProps) {
  return <svg {...base(size)} {...p}><path d="M3 9l1.5-6h15L21 9"/><path d="M3 9a3 3 0 006 0 3 3 0 006 0"/><path d="M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7"/><line x1="10" y1="16" x2="14" y2="16"/></svg>
}
...
export function UserCheckIcon({ size = 24, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p}>
...
export function QrCodeIcon({ size = 24, ...p }: IconProps) {
  return <QRIcon size={size} {...p} />
}

export function SunIcon({ size = 24, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p}>
